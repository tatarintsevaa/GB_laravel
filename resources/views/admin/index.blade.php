...
@section('content')
    <div class="container">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link text-dark" href="{{ route('admin.resource.index') }}">Добавление / редактирование ресурсов </a></li>
            <li class="nav-item"><a class="nav-link btn btn-danger w-25 mt-2" href="{{ route('admin.parser') }}">Парсинг</a></li>
        </ul>
    </div>
@endsection
